...
class ListHackerearth extends StatefulWidget {
  @override
  _ListHackerearthState createState() => _ListHackerearthState();
}

class _ListHackerearthState extends State<ListHackerearth> {
  ...
  Future<String> getData(String date) async{
    var response = await http.get(
        "https://clist.by/api/v1/contest/?username=Deep_123&api_key=dc1a808142d494c857cd6dba749858c16fd202c6"
            + "&limit=20&resource__id="+ "73" +"&start__gt="+ date + "&order_by=start",
        headers: {
